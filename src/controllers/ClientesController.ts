...
export default {
  async create(req: Request, res: Response) {
    try {
      const { nome, telefone, endereco_rua, endereco_numero, endereco_bairro, endereco_cidade, endereco_estado, carro_modelo, carro_placa, carro_ano, carro_cor, carro_problema } = req.body
      const data = { nome, telefone, endereco_rua, endereco_numero, endereco_bairro, endereco_cidade, endereco_estado, carro_modelo, carro_placa, carro_ano, carro_cor, carro_problema }
