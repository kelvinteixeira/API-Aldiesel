...
export default {
  async create(req: Request, res: Response) {
    try {
      const { nome_cliente, nome_mecanico, carro_modelo, carro_ano, carro_placa, carro_cor, problema_descricao, cliente_telefone, data_criacao, situacao_atual, os_img } = req.body
      const data = { cliente_telefone, data_criacao, situacao_atual, nome_cliente, nome_mecanico, carro_modelo, carro_ano, carro_placa, carro_cor, problema_descricao, os_img }
