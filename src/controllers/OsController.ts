...
export default {
  async create(req: Request, res: Response) {
    try {
      const { diagnostico, mecanico, data_criacao, data_alteracao, codigo, dtc, situacao, id_carro} = req.body
      const data = { diagnostico, mecanico, data_criacao, data_alteracao, codigo, dtc, situacao, id_carro}
