...
export default {
  async create(req: Request, res: Response) {
    try {
      const { diagnostico, data_criacao, data_alteracao, codigo, dtc, situacao, id_carro} = req.body
      const data = { diagnostico, data_criacao, data_alteracao, codigo, dtc, situacao, id_carro}
