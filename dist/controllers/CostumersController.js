...
exports.default = {
    ...
    find: function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, costumer, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = req.params.id;
                        return [4 /*yield*/, (0, connection_1.default)('costumers').where({ id: id })];
                    case 1:
                        costumer = _a.sent();
                        return [2 /*return*/, res.status(200).json(costumer)];
                    case 2:
                        err_3 = _a.sent();
                        return [2 /*return*/, res.status(500).json({
    ...
    update: function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, _a, name_2, phone, street, houseNumber, district, city, state, entryDate, data, costumer, err_4;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                        id = req.params.id;
                        _a = req.body, name_2 = _a.name, phone = _a.phone, street = _a.street, houseNumber = _a.houseNumber, district = _a.district, city = _a.city, state = _a.state, entryDate = _a.entryDate;
                        data = { name: name_2, phone: phone, street: street, houseNumber: houseNumber, district: district, city: city, state: state, entryDate: entryDate };
                        return [4 /*yield*/, (0, connection_1.default)('costumers').update(data).where({ id: id })];
                    case 1:
                        _b.sent();
                        return [4 /*yield*/, (0, connection_1.default)('costumers').where({ id: id })];
                    case 2:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = req.params.id;
                        return [4 /*yield*/, (0, connection_1.default)('costumers').delete().where({ id: id })];
                    case 1:
                        _a.sent();
