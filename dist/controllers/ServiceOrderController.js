...
exports.default = {
    create: function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, situation, diagnosis, changeDate, mechanic, idCar, code, dtc, dtcState, idServiceOrder, actions, data, dataDtcs_1, err_1;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        dataDtcs_1 = [{ code: code, dtc: dtc, dtcState: dtcState, idServiceOrder: idServiceOrder, actions: actions }];
                        return [4 /*yield*/, (0, connection_1.default)('service_orders').insert(data)];
                    case 1:
                        _b.sent();
                        dataDtcs_1.map(function (data) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, (0, connection_1.default)('dtcs').insert(dataDtcs_1)];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
