...
exports.default = {
    create: function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, situation, diagnosis, changeDate, mechanic, idCar, code, dtc, dtcState, idServiceOrder, actions, dataServiceOrder, dataDtcs, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        dataServiceOrder = { situation: situation, diagnosis: diagnosis, changeDate: changeDate, mechanic: mechanic, idCar: idCar };
